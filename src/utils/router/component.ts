...
type LayoutComponent = Record<AuthRoute.RouteLayoutType, Lazy<ModuleComponent>>;

/**
 * 获取布局的vue文件(懒加载的方式)
 * @param layoutType - 布局类型
 */
export function getLayoutComponent(layoutType: AuthRoute.RouteLayoutType) {
 ...
 */
export function getViewComponent(routeKey: RoutePage.LastDegreeRouteKey) {
  if (!views[routeKey]) {
